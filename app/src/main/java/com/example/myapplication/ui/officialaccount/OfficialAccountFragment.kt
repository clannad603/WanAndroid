...
import com.example.myapplication.ui.mainview.CommonViewPagerAdapter
import java.util.ArrayList

class OfficialAccountFragment:BaseFragment<OfficialAccountViewModel,FragmentOfficialAccountBinding> (){
