...
import com.example.myapplication.ui.mainview.fragmentcollect.project.ProjectChildFragment

class OfficialChildFragment:BaseFragment<OfficialAccountViewModel,FragmentOfficialChildBinding> (){
